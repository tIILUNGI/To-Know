...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    "menu.legal": "Requisitos Legais",
     "menu.docRegistration": "Cadastramento de Documentacão",
    ...
    "legal.active": "Documentos Activos",
    ...
    // Doc Registration
     "docReg.title": "Cadastramento de Documentacão",
    "docReg.new_document": "Novo Documento",
     "docReg.archive": "Arquivo de Documentacão",
     "docReg.subtitle": "Registo e controlol de toda a documentacão da empresa.",
    ...
    "eval.title": "Processos de Avaliações",
     "eval.quick_actions": "Acções Rápidas de Avaliacão",
